...
* **PH Core PWD Disability Registration**

## Extension: PH Core PWD Disability Registration (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-pwd-disability | *Version*:0.2.0 |
| Draft as of 2026-05-27 | *Computable Name*:PHCorePWDDisability |
...
```json
{
  ...
  "url" : "http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-pwd-disability",
  "version" : "0.2.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://doh.gov.ph/fhir/ph-core/ValueSet/ph-core-disability-type-vs"
      }
    },
    {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-pwd-disability"
    },
    {
