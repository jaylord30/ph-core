...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreImmunization |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-immunization.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Immunization.extension:batchNumber",
      "extension" : [{
        "extension" : [{
          "url" : "code",
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://doh.gov.ph/fhir/ph-core/StructureDefinition/batch-number"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://doh.gov.ph/fhir/ph-core/StructureDefinition/administered-product"]
      }],
      "mustSupport" : true
    },
    {
