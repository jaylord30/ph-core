...
| | |
| :--- | :--- |
| *Official URL*:http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-allergyintolerance | *Version*:0.2.0 |
| Draft as of 2026-05-27 | *Computable Name*:PHCoreAllergyIntolerance |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-allergyintolerance.json)
...
```json
{
  ...
  "url" : "http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-allergyintolerance",
  "version" : "0.2.0",
