# PH Core Medication Administration - Draft PH Core Implementation Guide v0.2.0
...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreMedicationAdministration |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-medicationadministration.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "MedicationAdministration.performer.function.text",
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/elementdefinition-translatable",
        "valueBoolean" : true
      },
      ...
      "path" : "MedicationAdministration.performer.function.text",
      "mustSupport" : true
    },
    {
