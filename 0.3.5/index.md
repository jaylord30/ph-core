...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreImplementationGuide |
...
* [Claim Type Codes](http://hl7.org/fhir/R4/codesystem-claim-type.html): [Claim/claim-single-example](Claim-claim-single-example.md)
...
* [Claim Care Team Role Codes](http://hl7.org/fhir/R4/codesystem-claim-careteamrole.html): [Claim/claim-single-example](Claim-claim-single-example.md)
* [Example Diagnosis Type Codes](http://hl7.org/fhir/R4/codesystem-ex-diagnosistype.html): [Claim/claim-single-example](Claim-claim-single-example.md)
* [Claim Payee Type Codes](http://hl7.org/fhir/R4/codesystem-payeetype.html): [Claim/claim-single-example](Claim-claim-single-example.md)
* [Process Priority Codes](http://hl7.org/fhir/R4/codesystem-process-priority.html): [Claim/claim-single-example](Claim-claim-single-example.md)
...
* This resource includes content from SNOMED Clinical Terms® (SNOMED CT®) which is copyright of the International Health Terminology Standards Development Organisation (IHTSDO). Implementers of these specifications must have the appropriate SNOMED CT Affiliate license - for more information contact [http://www.snomed.org/snomed-ct/get-snomed-ct](http://www.snomed.org/snomed-ct/get-snomed-ct) or info@snomed.org

* [Practitioner role](http://hl7.org/fhir/R4/codesystem-practitioner-role.html): [PractitionerRole/practitionerrole-single-example](PractitionerRole-practitionerrole-single-example.md)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-05-27T18:51:04+00:00",
