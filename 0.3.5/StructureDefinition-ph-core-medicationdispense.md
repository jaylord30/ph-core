# PH Core Medication Dispense - Draft PH Core Implementation Guide v0.2.0
...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreMedicationDispense |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-medicationdispense.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "MedicationDispense.statusReason[x]:statusReasonCodeableConcept.text",
      "extension" : [{
      ...
      "path" : "MedicationDispense.statusReason[x].text",
      "mustSupport" : true
    },
    {
