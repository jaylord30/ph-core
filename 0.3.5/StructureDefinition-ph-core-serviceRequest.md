# PH Core ServiceRequest - Draft PH Core Implementation Guide v0.2.0
...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreServiceRequest |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-serviceRequest.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "ServiceRequest.asNeeded[x]:asNeededCodeableConcept.text",
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/elementdefinition-translatable",
        "valueBoolean" : true
      },
      ...
      "path" : "ServiceRequest.asNeeded[x].text",
      "mustSupport" : true
    },
    {
