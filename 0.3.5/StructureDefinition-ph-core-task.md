...
| Draft as of 2026-05-27 | *Computable Name*:PHCoreTask |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.ph.core|current/StructureDefinition/StructureDefinition-ph-core-task.json)
