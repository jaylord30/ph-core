...
* **PH Core Disability Type Code System**

## CodeSystem: PH Core Disability Type Code System (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://doh.gov.ph/fhir/ph-core/CodeSystem/ph-core-disability-type-cs | *Version*:0.2.0 |
| Draft as of 2026-05-27 | *Computable Name*:PHCoreDisabilityTypeCS |
...
```json
{
  ...
  "url" : "http://doh.gov.ph/fhir/ph-core/CodeSystem/ph-core-disability-type-cs",
  "version" : "0.2.0",
