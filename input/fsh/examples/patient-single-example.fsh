...
* extension[indigenousPeople].url = "http://doh.gov.ph/fhir/phcore/StructureDefinition/indigenous-people"
* extension[indigenousPeople].valueBoolean = true
* extension[indigenousGroup].url = "http://doh.gov.ph/fhir/phcore/StructureDefinition/indigenous-group"
* extension[indigenousGroup].valueCodeableConcept = IndigenousGroupsCS#Aetas "Aetas"
* extension[race].url = "http://doh.gov.ph/fhir/phcore/StructureDefinition/race"
* extension[race].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/v3-Race#2036-2 "Filipino"
* extension[educationalAttainment].url = "http://doh.gov.ph/fhir/phcore/StructureDefinition/educational-attainment"
